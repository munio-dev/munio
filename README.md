...
munio was built by scanning 700+ real MCP servers and responsibly disclosing the vulnerabilities found. It works with MCP, OpenClaw, LangChain, CrewAI, and OpenAI Agents SDK.
...
Adapters for LangChain, CrewAI, OpenAI Agents SDK, and MCP. [See docs.](https://munio.dev/docs/getting-started)

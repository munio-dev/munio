...
class _MultilingualBackend:
    ...
    def __init__(self, model_dir: Path) -> None:
        import joblib  # type: ignore[import-untyped,unused-ignore]
    ...
    def predict_batch(self, texts: list[str]) -> list[float]:
        ...
        return probs[:, 1].tolist()  # type: ignore[no-any-return]  # column 1 = malicious
...
class L26MultilingualAnalyzer:
    ...
    def __init__(
        ...
        try:
            import joblib  # type: ignore[import-untyped,unused-ignore]  # noqa: F401
        except ImportError:
            logger.info(

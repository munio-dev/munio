...
from tests.core.conftest import (
    CONSTRAINTS_DIR,
    make_rate_limit_constraint,
    make_sequence_deny_constraint,
)
from tests.core.conftest import (
...
class TestActionBlockedError:
    ...
    def test_inherits_munio_error(self) -> None:
        ...
        assert isinstance(err, MunioError)
...
class TestGuardCheck:
    ...
    def test_invalid_dict_raises(self) -> None:
        ...
        with pytest.raises(MunioError, match="Invalid action format"):
